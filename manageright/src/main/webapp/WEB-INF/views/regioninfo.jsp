...
<jsp:body>
    ...
    <div id="regioninfo">
            ...
            <p><span class="infolabel">
                    Region ID </span><span class="infovalue"> ${obj.getRegion_ID()}
            </span></p>
            <p><span class="infolabel">
                    Name </span><span class="infovalue"> ${obj.getName()}
            </span></p>
            <p><span class="infolabel">
                    Located In : ${obj.getLocatedIn()}
            </span></p>
            <button onclick="location.href='/Admin/setregionlocatedin/${obj.getRegion_ID()}'">Set Located In</button>
