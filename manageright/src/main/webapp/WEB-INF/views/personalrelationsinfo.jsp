...
<jsp:body>
    ...
    <div id="personalrelationsinfo">
            ...
            <p><span class="infolabel">
                    Personal Relation ID </span><span class="infovalue"> ${obj.getPR_ID()}
            </span></p>
            <p><span class="infolabel">
                    Name </span><span class="infovalue"> ${obj.getName()}
            </span></p>
            <p><span class="infolabel">
                    Mobile </span><span class="infovalue"> ${obj.getMobile()}
            </span></p>
            <p><span class="infolabel">
                    Email </span><span class="infovalue"> ${obj.getEmail()}
            </span></p>
            <p><span class="infolabel">
